...
If the Sunkenland Dedicated Server for cannot find the world files, it will post the respective message to the console.
...
| GAME_MAX_PLAYER        |                                                                             Set the maximum of allowed plaxer for you instance. Max is 15.                                                                              |             3 |        no |
...
| GAME_SESSION_INVISIBLE | Set the game session to invisible. If set to "true", game will not be visible in the dedicated server overview within the game. You must either invite your friends or join by ServerID which is posted to the log file |         false |        no |
